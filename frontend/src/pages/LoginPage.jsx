    ...
    <div className="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden text-[#0e1b0e] dark:text-gray-200">
      <div className="flex-grow flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-sm mx-auto flex flex-col items-center">
          ...
          {/* Image */}
          <div className="flex w-full @container pb-2">
            <div className="w-full gap-1 overflow-hidden bg-[#f8fcf8] @[480px]:gap-2 aspect-[4/3] rounded-xl flex">
              <div
          ...
          {/* Text Content */}
          <h1 className="text-[#0e1b0e] dark:text-gray-100 tracking-tight text-[32px] font-bold leading-tight px-4 text-center pb-2 pt-6">
            Effortless Canteen Ordering.
          </h1>
          <p className="text-[#0e1b0e] dark:text-gray-300 text-base font-normal leading-normal pb-6 pt-1 px-4 text-center">
